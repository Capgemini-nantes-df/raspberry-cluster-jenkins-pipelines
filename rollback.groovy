...
node {
  ...
  stage('Try to launch website update') {
    globalMethods.executeCommandOnPrimaryNode("docker service update --image " + globalMethods.SLAVE_REGISTRY_URL +"/resto:orange --update-delay 0s --update-parallelism 2 --update-failure-action " +
