...
node {
  ...
  stage('Launch v2 service deployment') {
    globalMethods.executeCommandOnPrimaryNode("docker service create -d -p 82:80 --replicas 20 --restart-condition any --limit-memory 20M --name resto-legacy --network " +
